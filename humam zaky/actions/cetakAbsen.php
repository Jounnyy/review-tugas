...
<html>
    ...
    <td class="c7" colspan="1" rowspan="1"><p class="c2"><span class="c4">JAM MASUK</span></p></td><td class="c7" colspan="1" rowspan="1"><p class="c2"><span class="c4">JAM KELUAR</span></p></td></tr><tr class="c5"><td class="c7" colspan="1" rowspan="1"><p class="c2"><span class="c6">
    <?= date("d-m-Y", strtotime($Detail['tanggal']))?></span></p></td><td class="c7" colspan="1" rowspan="1"><p class="c2"><span class="c6">
    <?= date("d-m-Y", strtotime($Detail['jam_masuk']))?></span></p></td><td class="c7" colspan="1" rowspan="1"><p class="c2"><span class="c6">
    <?= date("d-m-Y", strtotime($Detail['jam_keluar']))?></span></p></td></tr></tbody></table></body></html>
