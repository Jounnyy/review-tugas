...
<body>
        ...
        <div class="side-navbar" style="background-color: var(--bs-dark-bg-subtle);">
            <nav>
                <ul>
                    ...
                    <li class="nav-item"><a href="#" class="fw-semibold"><i class="fa-solid fa-users"></i>&nbsp;&nbsp;Jumlah Karyawan</a></li>
    ...
    background-color:var(--bs-body-bg) ;" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><button class="dropdown-item" onclick="window.open('./print-table-jumlah.php')">Print Table</button></li>
                        </ul>
                    </div>
