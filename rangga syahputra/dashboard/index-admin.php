...
<body>
        ...
        <div class="side-navbar" style="background-color: var(--bs-dark-bg-subtle);">
            <nav>
                <ul>
                    ...
                    <li class="nav-item"><a href="./sudah-clockin.php" class="fw-semibold"><i class="fa-solid fa-right-to-bracket"></i>&nbsp;&nbsp;Sudah ClockIn</a></li>
                ...
                <nav>
                    <ul>
                        <li class="h-100 align-items-center">
                                <a href="" class="title-admin" style="color:var(--bs-emphasis-color)">Admin</a>
                        </li>
                    </ul>
                    <div class="dropdown">
    ...
    background-color:var(--bs-body-bg) ;" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><button class="dropdown-item" onclick="window.open('./print-table.php')">Print Table</button></li>
                        </ul>
                    </div>
    ...
    background-color:var(--bs-body-bg) ;" type="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <div class="item-admin d-flex ">
                <div class="item-admin-start" style="width: 65%; height:585px">
                    ...
                    <div class="data-karyawan ">
                        <div class="output-karyawan d-flex gap-2" style="width:99%">
                            ...
                            <div class="h-auto p-4 rounded-2 " style="background-color:var(--bs-primary-bg-subtle);color:var(--bs-primary-text); border: 1px solid var(--bs-primary-border-subtle);width:430px">
                                <!-- OUTPUT JUMLAH CLOCKIN -->
                                <p class="fw-semibold"><i class="fa-solid fa-right-to-bracket"></i>&nbsp;&nbsp;Karyawan ClockIn</p>
                                <h4 style="color:var(--bs-primary-text)">
                                    <?php
                                    include("../connection.php");
                ...
                <div class="item-admin-end d-flex flex-column ms-1" style="width: 35%;  font-family: 'Open Sans', sans-serif;">
                    ...
                    <div class="admin-status d-flex flex-column justify-content-evenly p-4 mt-2 rounded-2" style="width:95%; height:38%;background-color:var(--bs-body-color); color: var(--bs-body-bg); ">
