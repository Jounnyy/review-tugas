...
<body>
        ...
        <div class="side-navbar" style="background-color: var(--bs-dark-bg-subtle);">
            <nav>
                <ul>
                    ...
                    <li class="nav-item"><a href="#" class="fw-semibold"><i class="fa-solid fa-right-from-bracket"></i>&nbsp;&nbsp;Sudah ClockOut</a></li>
                </ul>
            </nav>
        </div>
    ...
    background-color:var(--bs-body-bg) ;" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><button class="dropdown-item" onclick="window.open('./print-table-clockout.php')">Print Table</button></li>
                        </ul>
                    </div>
            ...
            <div class="item-admin d-flex ">
                <div class="item-admin-start" style="width: 65%; height:585px">
                    ...
                    <table class="table table-striped ms-2 me-2 mt-2" style="width:98%">
                        ...
                        $sql = "SELECT * FROM users JOIN absensi ON users.user_id = absensi.user_id WHERE tgl = '$tgl' AND jam_masuk IS NOT NULL AND jam_keluar IS NOT NULL";
                        $result = $db->query($sql);
